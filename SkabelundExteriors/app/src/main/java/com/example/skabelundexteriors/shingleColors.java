...
public class shingleColors extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.harvest_gold).setOnClickListener(button -> {
            navController.navigate(R.id.action_shingleColors_to_harvestGold);
        });
        view.findViewById(R.id.mountain_slate).setOnClickListener(button -> {
            navController.navigate(R.id.action_shingleColors_to_mountainSlate);
        });
